(() => {
    ...
    if (window.location.toString().indexOf("home.html") > 0) document.addEventListener("DOMContentLoaded", (() => {
        const newYear = new Date("Jan 1 2024 00:00:00");
        const hoursVal = document.querySelector(".timer-magic__hour .timer-magic__val");
        const minutesVal = document.querySelector(".timer-magic__minutes .timer-magic__val");
        const secondsVal = document.querySelector(".timer-magic__seconds .timer-magic__val");
        const timeCount = () => {
            let now = new Date;
            let leftUntil = newYear - now;
            let hours = Math.floor(leftUntil / 1e3 / 60 / 60);
    ...
    if (window.location.toString().indexOf("nft.html") > 0) document.addEventListener("DOMContentLoaded", (() => {
        const newYear = new Date("Jan 1 2024 00:00:00");
        const hoursVal = document.querySelector(".timer-magic__hour .timer-magic__val");
        const minutesVal = document.querySelector(".timer-magic__minutes .timer-magic__val");
        const secondsVal = document.querySelector(".timer-magic__seconds .timer-magic__val");
